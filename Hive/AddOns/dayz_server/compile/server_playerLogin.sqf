...
if(_playerID in botPlayers) exitWith {
diag_log format ["DISCOBOT: Player %1 (%2) has a Bot!",_playerName, _playerID];
...
if (!_isNew) then {
	...
	if (!(_model in AllPlayers)) then {
		_model = CivPlayers select floor random count CivPlayers;
	};
...
([12973,9814,0] nearestObject 260217) setDamage 1;
([12973,9814,0] nearestObject 260211) setDamage 1;
([4309,10982,0] nearestObject 136549) setDamage 1;
([7089,2558,0] nearestObject 970069) setDamage 1;
